...
describe('rankRepresentativeTraces', () => {
  it('sorts by selected span count and uses traceId as deterministic tie-breaker', () => {
    const rows = [
      { traceId: 'trace-c', selectedSpanCount: 3, maxDurationMs: 1200 },
      { traceId: 'trace-a', selectedSpanCount: 7, maxDurationMs: 800 },
      { traceId: 'trace-b', selectedSpanCount: 7, maxDurationMs: 700 },
      { traceId: 'trace-d', selectedSpanCount: 1, maxDurationMs: 200 },
    ];
